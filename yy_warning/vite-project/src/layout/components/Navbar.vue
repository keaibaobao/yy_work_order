...
<!-- renhao 不需要隐藏边框   <Hamburger class="hamburger-container" :is-active="opened" @toggleClick="toggleSideBar" />-->
 <Breadcrumb class="breadcrumb-container"/>
    <div class="right-menu">
<!-- renhao不需要全屏组件      <el-tooltip effect="dark" content="全屏" placement="bottom">-->
